        ...
        <div className="px-6 pb-6">
          <div className="mb-6">
            <h3 className="text-slate-900 mb-1 flex items-center gap-2">
              ...
              <MentorshipTooltip 
                term="Alpha"
                definition="Extra profit generated by institutional math. Alpha is the return above the market baseline—this is what you're hunting when trading S&P inclusion events."
                position="bottom"
              />
            </h3>
